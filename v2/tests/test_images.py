...
from v2.services.images import get_image_url, ERROR_JPG, DEFAULT_CREDIT, MY_IMAGES
...
class TestGetImageUrl:
    ...
    async def test_unsplash_success(self):
        ...
        with patch("v2.services.images.httpx.AsyncClient", return_value=mock_client):
