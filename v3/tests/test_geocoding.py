...
from v3.services.geocoding import geocode_city, geocode_cities
...
class TestGeocodeCity:
    ...
    async def test_successful_geocode(self):
        ...
        with patch("v3.services.geocoding.httpx.AsyncClient", return_value=mock_client):
...
class TestGeocodeCities:
    ...
    async def test_multiple_cities(self):
        ...
        with patch("v3.services.geocoding.geocode_city", side_effect=mock_geocode):
