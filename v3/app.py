"""FastAPI application — Couch Traveller V3."""
...
from v3.routers.api import router as api_router
from v3.routers.pages import router as pages_router

error_templates = Jinja2Templates(directory=str(V3_DIR / "templates"))
from v3.services.cache import Cache
from v3.services.llm import create_client
